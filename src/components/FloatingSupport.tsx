const FloatingSupport = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end space-y-4">
      {/* Support Button */}
      <button
        className="w-14 h-14 md:w-16 md:h-16 bg-conecta-orange rounded-full flex items-center justify-center shadow-2xl hover:bg-conecta-orange-dark transition-all duration-300 transform hover:scale-110"
        aria-label="Soporte"
